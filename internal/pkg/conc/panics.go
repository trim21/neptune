...
// value of the first panic caught, wrapped in a Recovered with caller
// information.
...
// NewRecovered creates a Recovered from a panic value and a collected
...
// ErrRecovered wraps a Recovered in an error implementation.
