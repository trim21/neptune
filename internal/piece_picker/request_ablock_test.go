...
func TestRequestABlock_AllCompleted(t *testing.T) {
	...
	result := pp.RequestABlock(PickResult{}, 8, 0, 0, false, nil, nil, bm.New(0))
...
func TestRequestABlock_QueueFull(t *testing.T) {
	...
	result := pp.RequestABlock(PickResult{}, 8, 8, 0, false, nil, nil, bm.New(0))
	require.Empty(t, result.FreeBlocks)
	require.Empty(t, result.BusyBlocks)
}
...
func TestRequestABlock_QueueFullWithQueued(t *testing.T) {
	pp := newTestPicker(5, 4)
	result := pp.RequestABlock(PickResult{}, 8, 4, 4, false, nil, nil, bm.New(0))
	require.Empty(t, result.FreeBlocks)
	require.Empty(t, result.BusyBlocks)
}
...
func TestRequestABlock_ChokedNoFast(t *testing.T) {
	...
	result := pp.RequestABlock(PickResult{}, 8, 0, 0, true, peerBitfield, nil, bm.New(0))
...
func TestRequestABlock_ChokedWithFast(t *testing.T) {
	...
	result := pp.RequestABlock(PickResult{}, 8, 0, 0, true, peerBitfield, fastBm, bm.New(0))
...
func TestRequestABlock_UnchokedNormal(t *testing.T) {
	...
	result := pp.RequestABlock(PickResult{}, 8, 0, 0, false, peerBitfield, nil, bm.New(0))
...
func TestRequestABlock_LastPickResultReuse(t *testing.T) {
	...
	result := pp.RequestABlock(last, 8, 0, 0, false, peerBitfield, nil, bm.New(0))
